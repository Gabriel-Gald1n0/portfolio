      ...
      <div className="container mx-auto relative z-10">
        <div className="text-center mb-8">
          ...
          <div className="flex justify-center gap-6">
            <a
              href="https://github.com/Gabriel-Gald1n0"
              target="_blank"
            ...
            <a
              href="https://www.linkedin.com/in/gabriel-gald1n0/"
              target="_blank"
              rel="noopener noreferrer"
              className="w-12 h-12 bg-[#2a2a2a] border-2 border-[#d4af37] flex items-center justify-center hover:bg-[#d4af37] hover:text-[#1a1a1a] transition-all group"
            >
            ...
            <a
              href="mailto:gabrielrosagaldino@gmail.com?subject=Contato do Portfólio"
              className="w-12 h-12 bg-[#2a2a2a] border-2 border-[#d4af37] flex items-center justify-center hover:bg-[#d4af37] hover:text-[#1a1a1a] transition-all group"
            >
            ...
            >
              <FileText className="w-5 h-5 text-[#d4af37] group-hover:text-[#1a1a1a]" />
            </a>
          </div>
        </div>
        <div className="text-center border-t-2 border-[#4a4a4a] pt-6">
          ...
          <p className="text-[8px] text-[#d4af37] mt-2">{t.footer.quote}</p>
        </div>
      </div>
    </footer>
  );
